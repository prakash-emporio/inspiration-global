    ...
    <div className="container-fluid company-text-margin margin-code">
      ...
      <div className="my-md-3 py-md-3 mb-lg-5 py-lg-5">
        <div className="row g-0">
          ...
          <div className="col-md-10 col-lg-7 service-testimonial-text text-white z-2">
            <p>
              Inspiration Global (IG) is dedicated to partnering with both
        ...
        <div className="row g-0">
          <div className="col-md-10 col-lg-7 service-testimonial-text text-white">
            <p>
              ...
              technology and business solutions across the global landscape, IG
              stands out as a trusted partner. In addition to adeptly
              implementing a diverse array of off-the-shelf and Software as a
              Service (SaaS) solutions, IG excels in crafting tailor-made
              applications, harnessing the power of cloud computing, and
              utilizing analytics and business intelligence. These capabilities
              enable companies to strategically align their operations with the
              ever-evolving demands of both their business and customer base,
