      ...
      <div className="container my-lg-5 py-lg-5">
        ...
        <div className="col-lg-6 service-testimonial-text">
          <p>
            ...
            streamlining talent acquisition and staffing processes, effectively
            reducing recruitment timelines for clients spanning diverse
            industries. Recognizing the importance of allowing your recruiting
            team to focus on their primary tasks, we offer efficient staffing
            and talent solutions that complement your in-house efforts.
          </p>
        </div>
